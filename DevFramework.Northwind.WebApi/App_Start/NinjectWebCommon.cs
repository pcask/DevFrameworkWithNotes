    ...
    public static class NinjectWebCommon
    {
        ...
        private static IKernel CreateKernel()
        {
            ...
            try
            {
                ...
                // Api projemiz de ayni Mvc projemizde oldugu gibi paramaterless public constructor ister.
                // Mvc kisminda SetControllerFactory islemini Api kisminda asagidaki tek satirlik kod ile ele aliyoruz;
        ...
        {
            // Tüm Dependency Resolve islemlerinin tek çati altinda yönetilmesi için hazirlamis oldugumuz BusinessModule ve AutoMapperModule'i
            // Ninject'in kernel'ina yüklüyoruz.
